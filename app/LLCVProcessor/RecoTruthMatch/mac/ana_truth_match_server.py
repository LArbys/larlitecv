...
if len (sys.argv) != 7:
    ...
    print "SUPERA_FILE     = str(sys.argv[3])"
    print "SSNET_FILE      = str(sys.argv[4])"
    print "[TRK|SHR]_FILE  = str(sys.argv[5])"
...
TYPE          = str(sys.argv[2])
SUPERA_FILE   = str(sys.argv[3])
SSNET_FILE    = str(sys.argv[4])
TRK_SHR_FILE  = str(sys.argv[5])
