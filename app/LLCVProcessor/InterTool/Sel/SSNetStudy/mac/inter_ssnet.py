...
selection = llcv.SelSSNetStudy()
driver.AddSelection(selection);

# process
proc.add_llcv_ana(imod)

proc.configure(os.path.join(BASE_PATH,"inter_ssnet.cfg"))
proc.dataco().set_outputfile(os.path.join(OUT_DIR, "ssnet_trash.root"),"larcv")
