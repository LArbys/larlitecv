...
std::vector<double> larlitecv::ssnetshowerreco::Utils::GetPosOffsets(std::vector<double> const& point, TH3F* hX, TH3F* hY, TH3F* hZ){
...
std::vector<double> larlitecv::ssnetshowerreco::Utils::GetOffsetsVoxel(std::vector<double> const& point,TH3F* hX, TH3F* hY, TH3F* hZ){
...
double larlitecv::ssnetshowerreco::Utils::TransformX(double xVal){
  double xValNew;
...
double larlitecv::ssnetshowerreco::Utils::TransformY(double yVal){
  double yValNew;
...
double larlitecv::ssnetshowerreco::Utils::TransformZ(double zVal){
  double zValNew;
...
//----------------------------------------------------------------------------
std::vector<double> larlitecv::ssnetshowerreco::Utils::Transform( std::vector<double> const& point){
  return
...
bool larlitecv::ssnetshowerreco::Utils::IsInsideBoundaries(std::vector<double> const& point){
  return !(
...
bool larlitecv::ssnetshowerreco::Utils::InsideFiducial(float x, float y, float z){
  return !(
       (x <    0.001) || (x >  255.999)
    || (y < -116.499) || (y > 116.499)
    || (z <    0.001) || (z > 1036.999)
...
bool larlitecv::ssnetshowerreco::Utils::IsTooFarFromBoundaries(std::vector<double> const& point){
  return (
...
std::vector<double> larlitecv::ssnetshowerreco::Utils::PretendAtBoundary(std::vector<double> const& point){
...
std::vector<int> larlitecv::ssnetshowerreco::Utils::getProjectedPixel( const std::vector<double>& pos3d,
...
std::vector<double> larlitecv::ssnetshowerreco::Utils::MakeSCECorrection (std::vector<double> newvec,
...
int larlitecv::ssnetshowerreco::Utils::GetSliceNumber(float resrange){
  int slicenumber;
...
float larlitecv::ssnetshowerreco::Utils::CalculateSliceWeight(TH1D* muon_slice,TH1D* proton_slice){
  float weight = 1.0;
