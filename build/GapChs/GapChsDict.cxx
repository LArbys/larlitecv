   ...
   namespace ROOT {
      ...
      inline ::ROOT::TGenericClassInfo *GenerateInitInstance()
      {
         static ::ROOT::TGenericClassInfo 
            instance("larlitecv", 0 /*version*/, "EmptyChannelAlgo.h", 15,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::larlitecv::EmptyChannelAlgo*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("larlitecv::EmptyChannelAlgo", "EmptyChannelAlgo.h", 17,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::larlitecv::GapChProcessor*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("larlitecv::GapChProcessor", "GapChProcessor.h", 11,
