   ...
   namespace ROOT {
      ...
      inline ::ROOT::TGenericClassInfo *GenerateInitInstance()
      {
         static ::ROOT::TGenericClassInfo 
            instance("larlitecv", 0 /*version*/, "Base/DataCoordinator.h", 20,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::larlitecv::LarliteFileManager*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("larlitecv::LarliteFileManager", "Base/LarliteFileManager.h", 11,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::larlitecv::LarcvFileManager*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("larlitecv::LarcvFileManager", "Base/LarcvFileManager.h", 11,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::larlitecv::DataCoordinator*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("larlitecv::DataCoordinator", "Base/DataCoordinator.h", 24,
