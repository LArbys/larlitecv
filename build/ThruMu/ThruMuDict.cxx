...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::larlitecv::PointInfo*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("larlitecv::PointInfo", "Linear3DFitter.h", 16,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::larlitecv::PointInfoList*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("larlitecv::PointInfoList", "Linear3DFitter.h", 45,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::larlitecv::Linear3DFitterConfig*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("larlitecv::Linear3DFitterConfig", "Linear3DFitter.h", 76,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::larlitecv::Linear3DFitter*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("larlitecv::Linear3DFitter", "Linear3DFitter.h", 92,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::larlitecv::AStar3DAlgoConfig*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("larlitecv::AStar3DAlgoConfig", "AStar3DAlgo.h", 237,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::larlitecv::AStar3DAlgo*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("larlitecv::AStar3DAlgo", "AStar3DAlgo.h", 261,
...
namespace larlitecv{class __attribute__((annotate("$clingAutoload$BoundaryMuonTaggerAlgo.h")))  Linear3DFitterConfig;}
namespace larlitecv{class __attribute__((annotate("$clingAutoload$BoundaryMuonTaggerAlgo.h")))  Linear3DFitter;}
